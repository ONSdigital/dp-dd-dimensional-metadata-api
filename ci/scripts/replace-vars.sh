...
sed dp-dd-dimensional-metadata-api/appspec.yml dp-dd-dimensional-metadata-api/scripts/codedeploy/* -i \
...
cp dp-dd-dimensional-metadata-api/appspec.yml artifacts/
cp dp-dd-dimensional-metadata-api/scripts/codedeploy/* artifacts/scripts/codedeploy
